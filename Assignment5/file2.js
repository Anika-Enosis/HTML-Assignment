function DeleteRow(ID) {
  ...
  if (x)
    ...
    return false;
     ...
     var url,oldName,OldAddr,OldRating,oldImage;
     var ID_seq=3;
     ...
     function ResetRow(ID)
     {
             ...
             td.getElementsByTagName("td")[3].innerHTML=oldImage;
             oldName="";
             OldAddr="";
             OldRating="";
             var reset = document.getElementById("Reset");
     ...
     function NewUpdate(ID){
             ...
             oldImage=td.getElementsByTagName("td")[3].innerHTML;
            ...
            document.getElementById("img").value = new File([""], "C:\\Users\\tabassum\\Pictures\\Screenshots\\Screenshot (2).png");
             var submit = document.getElementById("Submit");
